...
visuales que puede asumir el gráfico de un campo luego 
de ser dividido en varias partes según el número de 
categorías que el campo en cuestión contenga; es decir, 
a partir de la 'granularidad de los datos' de un campo, 
se crean representaciones visuales por separado para cada 
...
las Coordenadas: cómo querer observar tu gráfico 
